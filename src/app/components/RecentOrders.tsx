...
const RecentOrders = () => {
    return (
        <div 
            className="w-full col-span-1 relative lg:h-[70vh] h-[50vh] m-auto p-4 border rounded-lg bg-white overflow-y-auto dark:bg-[#171C2F]"
        >
                ...
                {data.map((order, id) => (
                    ...
                    >
                        ...
                        <div className="pl-4">
                            ...
                            <p className="text-gray-400 text-sm dark:text-white">{order.name.first} - ({order.method})</p>
                        </div>
                        <p 
                            className="lg:flex md:hidden absolute right-6 text-sm"
                        >
                            {order.date}
                        </p>
                    </li>
